...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, setCookie, getRequestIP, deleteCookie, getResponseStatusText } from 'file:///home/cheng/dev/stock-analysis/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/cheng/dev/stock-analysis/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///home/cheng/dev/stock-analysis/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///home/cheng/dev/stock-analysis/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { jwtVerify, SignJWT } from 'file:///home/cheng/dev/stock-analysis/node_modules/jose/dist/webapi/index.js';
import { Resend } from 'file:///home/cheng/dev/stock-analysis/node_modules/resend/dist/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/cheng/dev/stock-analysis/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file:///home/cheng/dev/stock-analysis/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/cheng/dev/stock-analysis/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/cheng/dev/stock-analysis/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/cheng/dev/stock-analysis/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/cheng/dev/stock-analysis/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/cheng/dev/stock-analysis/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///home/cheng/dev/stock-analysis/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/cheng/dev/stock-analysis/node_modules/unstorage/drivers/fs.mjs';
import fsDriver from 'file:///home/cheng/dev/stock-analysis/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///home/cheng/dev/stock-analysis/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest } from 'file:///home/cheng/dev/stock-analysis/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/cheng/dev/stock-analysis/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/cheng/dev/stock-analysis/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/cheng/dev/stock-analysis/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/cheng/dev/stock-analysis/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/cheng/dev/stock-analysis/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/cheng/dev/stock-analysis/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/cheng/dev/stock-analysis/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/cheng/dev/stock-analysis/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/cheng/dev/stock-analysis/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/cheng/dev/stock-analysis/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/cheng/dev/stock-analysis/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///home/cheng/dev/stock-analysis/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///home/cheng/dev/stock-analysis/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/cheng/dev/stock-analysis/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/cheng/dev/stock-analysis/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/cheng/dev/stock-analysis/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///home/cheng/dev/stock-analysis/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/cheng/dev/stock-analysis/server/assets"}];
...
const _47home_47cheng_47dev_47stock_45analysis_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/cheng/dev/stock-analysis","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/cheng/dev/stock-analysis/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', _47home_47cheng_47dev_47stock_45analysis_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/home/cheng/dev/stock-analysis/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/home/cheng/dev/stock-analysis/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/cheng/dev/stock-analysis/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/cheng/dev/stock-analysis/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/cheng/dev/stock-analysis/.data/kv"}));
...
const _Na94fJIjsApVju5rHUNootDlmc8VMulbVV7vMiWl50o = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/cheng/dev/stock-analysis";
...
const _XSuSDykc_Qj6bf2FpNx2xTDN3Ccl8lZ1MMbFAzn_85w = (nitroApp) => {
...
const plugins = [
  _Na94fJIjsApVju5rHUNootDlmc8VMulbVV7vMiWl50o,
_XSuSDykc_Qj6bf2FpNx2xTDN3Ccl8lZ1MMbFAzn_85w,
...
const _ZfHey8 = eventHandler((event) => {
...
const _lazy_2_cyVb = () => Promise.resolve().then(function () { return callback_get$3; });
const _lazy_eJUu3f = () => Promise.resolve().then(function () { return index_get$3; });
const _lazy_zeiT5_ = () => Promise.resolve().then(function () { return forgotPassword_post$1; });
const _lazy_kUZ0Pc = () => Promise.resolve().then(function () { return callback_get$1; });
const _lazy_p8H2gh = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_5kzcOQ = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_hHElnK = () => Promise.resolve().then(function () { return logout_post$1; });
const _lazy_86f6HT = () => Promise.resolve().then(function () { return me_get$1; });
const _lazy_sTBGWi = () => Promise.resolve().then(function () { return register_post$1; });
const _lazy_iIPWGR = () => Promise.resolve().then(function () { return resetPassword_post$1; });
const _lazy_eyymwa = () => Promise.resolve().then(function () { return feedback_post$1; });
const _lazy_g4xBk1 = () => Promise.resolve().then(function () { return feedbacks_get$1; });
const _lazy_n_pz28 = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _ZfHey8, lazy: false, middleware: true, method: undefined },
  { route: '/api/auth/facebook/callback', handler: _lazy_2_cyVb, lazy: true, middleware: false, method: "get" },
  { route: '/api/auth/facebook', handler: _lazy_eJUu3f, lazy: true, middleware: false, method: "get" },
  { route: '/api/auth/forgot-password', handler: _lazy_zeiT5_, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/google/callback', handler: _lazy_kUZ0Pc, lazy: true, middleware: false, method: "get" },
  { route: '/api/auth/google', handler: _lazy_p8H2gh, lazy: true, middleware: false, method: "get" },
  { route: '/api/auth/login', handler: _lazy_5kzcOQ, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/logout', handler: _lazy_hHElnK, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/me', handler: _lazy_86f6HT, lazy: true, middleware: false, method: "get" },
  { route: '/api/auth/register', handler: _lazy_sTBGWi, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/reset-password', handler: _lazy_iIPWGR, lazy: true, middleware: false, method: "post" },
  { route: '/api/feedback', handler: _lazy_eyymwa, lazy: true, middleware: false, method: "post" },
  { route: '/api/feedbacks', handler: _lazy_g4xBk1, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_n_pz28, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_n_pz28, lazy: true, middleware: false, method: undefined }
];
...
const callback_get$2 = defineEventHandler(async (event) => {
  ...
  try {
    ...
    const userData = await $fetch(`https://graph.facebook.com/me?fields=id,name,email&access_token=${tokenRes.access_token}`);
    ...
    const jwt = await new SignJWT({ userId: user.id, email: user.email, jti }).setProtectedHeader({ alg: "HS256" }).setIssuedAt().setExpirationTime("7d").sign(secret);
...
const index_get$2 = defineEventHandler(async (event) => {
  ...
  setCookie(event, "oauth_state", state, { maxAge: 60 * 10, path: "/" });
...
const forgotPassword_post = defineEventHandler(async (event) => {
  ...
  if (isRateLimited(ip, "forgot-password", 3, 15 * 60 * 1e3)) {
...
const index_get = defineEventHandler(async (event) => {
  ...
  if (!env.GOOGLE_CLIENT_ID) {
    throw createError({
      statusCode: 500,
      statusMessage: `Google sign-in is not configured on this server. The GOOGLE_CLIENT_ID secret is missing. Set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET via \`wrangler secret put\` and ensure ${url.origin}/api/auth/google/callback is registered as an authorized redirect URI in the Google Cloud Console.`
    });
  }
  const clientId = env.GOOGLE_CLIENT_ID;
  const redirectUri = `${url.origin}/api/auth/google/callback`;
...
const login_post = defineEventHandler(async (event) => {
  const env = event.context.cloudflare.env;
  const ip = getRequestIP(event, { xForwardedFor: true }) || "127.0.0.1";
  if (isRateLimited(ip, "login", 10, 5 * 60 * 1e3)) {
...
const register_post = defineEventHandler(async (event) => {
  const env = event.context.cloudflare.env;
  const ip = getRequestIP(event, { xForwardedFor: true }) || "127.0.0.1";
  if (isRateLimited(ip, "register", 5, 15 * 60 * 1e3)) {
...
const feedback_post = defineEventHandler(async (event) => {
  const env = event.context.cloudflare.env;
  const ip = getRequestIP(event, { xForwardedFor: true }) || "127.0.0.1";
  if (isRateLimited(ip, "feedback", 5, 60 * 1e3)) {
  ...
  try {
    ...
    if (message.length > 1e3) throw createError({ statusCode: 400, statusMessage: "Message exceeds maximum length of 1000 characters" });
...
const feedbacks_get = defineEventHandler(async (event) => {
  const env = event.context.cloudflare.env;
  const cookieStr = getRequestHeader(event, "Cookie") || "";
  const match = cookieStr.match(/auth_token=([^;]+)/);
  if (!match) {
...
const feedbacks_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: feedbacks_get
}, Symbol.toStringTag, { value: 'Module' }));
