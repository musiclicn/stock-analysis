declare global {
  ...
  const buf2hex: typeof import('../../server/utils/auth').buf2hex
  ...
  const hashPasswordLegacy: typeof import('../../server/utils/auth').hashPasswordLegacy
  ...
  const isRateLimited: typeof import('../../server/utils/auth').isRateLimited
  ...
  const randomTokenBase64Url: typeof import('../../server/utils/auth').randomTokenBase64Url
  ...
  const sha256Hex: typeof import('../../server/utils/auth').sha256Hex
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/home/cheng/dev/stock-analysis/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/home/cheng/dev/stock-analysis/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { getJwtSecret, buf2hex, hashPasswordLegacy, hashPassword, sha256Hex, randomTokenBase64Url, isRateLimited, verifyAuthToken } from '/home/cheng/dev/stock-analysis/server/utils/auth';